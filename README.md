...
The image_stitcher.py creates a panorama of 4 scene photos (scene_1.jpeg ... scene_4.jpeg). Lines 9-26 are commented out as it takes a long time to run. I ran the code and saved the output to 4 files to prevent it from being run again. You can see the output of the harris corner detector code by running Image_Stitcher.py with those lines commented out. You can also uncomment those lines to run the code on new photos if you desire.
